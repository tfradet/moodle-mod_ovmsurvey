...
$string['reports_heading'] = 'Rapport d&rsquo;auto-évaluation';
$string['name'] = 'Nom';
...
$string['choice_label'] = 'choix de valeur';
$string['previous'] = 'précédent';
$string['next'] = 'suivant';
$string['hint_finish_step'] = 'Vous devez répondre à toutes les questions avant de passer à l’étape suivante.';
$string['end'] = 'Vous avez terminé le questionnaire';
